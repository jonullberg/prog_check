...
module.exports = function(app) {
  app.controller('SingleStandardCtrl', ['$scope', '$modal', '$modalInstance', '$cookies', '$rootScope', 'Errors', 'Standards', 'Students', function($scope, $modal, $modalInstance, $cookies, $rootScope, Errors, Standards, Students) {
