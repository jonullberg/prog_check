...
function sendForgotPasswordEmail(req, res) {
  ...
  function writeAndSendEmail(err, data) {
    ...
    emailText += '<a rel="nofolow" style="text-decoration:none">https://prog-check-beta.herokuapp.com/#/reset/' + encodeURIComponent(token) + '</a><br /><li>Follow the instructions to reset your password</li></p>';
